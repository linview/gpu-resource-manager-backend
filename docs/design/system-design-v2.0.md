>>> Updated at 2025-08-17 23:00:00 <<<
# GPU资源管理系统架构设计 (设计版本 v2.0 - 事件驱动架构)
...
- **负责人**: Architect
- **状态**: 基于评审结果修正完成 - 当前权威版本
- **文档命名**: system-design-v2.0.md (统一命名规范)

## 版本演进说明
- **v1.0**: 初始微服务架构设计 (已废弃，参考: system-design-v1.0.md)
- **v2.0**: 事件驱动架构设计 (当前权威版本)
  - 采用IaaS作为资源编排层架构
...
### 文档版本信息
- **当前版本**: v2.0 (权威版本)
- **文档命名**: system-design-v2.0.md
- **历史版本**: system-design-v1.0.md (已废弃)
